...
abstract class TweetSet {
   ...
   * in the original set for which the predicate is true.
    * ************************************************************
   * filter takes as argument a function, the predicate,
    * which takes a tweet and returns a boolean.
    * filter then returns the subset of all the tweets in the original set
...
class Empty extends TweetSet {
  /*  filterAcc which takes an accumulator set as a second argument.
  This accumulator contains the ongoing result of the filtering.   */
//  Propagetes the accumulated tweets.
  ...
  def remove(tweet: Tweet): TweetSet = this // this refer the object on which the current method is excuted.
